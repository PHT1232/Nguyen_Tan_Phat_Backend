...
namespace Nguyen_Tan_Phat_Project.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Nguyen_Tan_Phat_ProjectConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Nguyen_Tan_Phat_ProjectDbContext context)
        {
            _context = context;
        }
